...
const TopBar = ({
  ...
  const statusConfig = {
    disconnected: { color: "bg-red-500", text: "WebSocket Disconnected" },
    connecting: { color: "bg-yellow-500", text: "WebSocket Connecting" },
    connected: { color: "bg-green-500", text: "WebSocket Connected" },
    error: { color: "bg-red-500", text: "WebSocket Error" },
  };

  const currentStatus =
    statusConfig[websocketStatus] || statusConfig.disconnected;
