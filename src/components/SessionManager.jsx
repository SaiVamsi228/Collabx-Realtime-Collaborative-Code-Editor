...
function SessionManager() {
  ...
  const handleJoin = () => {
    navigate("/coding-environment"); // Redirect to CodingEnvi component
  };
        ...
        <div className="container mx-auto px-6 pb-6">
          <div className="max-w-3xl mx-auto">
            <div className="flex gap-4 mb-6">
              ...
              />
              <button className="flex items-center gap-2 px-6 py-3 bg-indigo-900 text-white font-semibold rounded-lg hover:bg-gray-100 hover:text-black hover:border-black border border-transparent transition-all">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200">
            ...
            {activeTab === "public" ? (
              <div className="max-h-[70vh] overflow-y-auto pr-4">
                <div className="bg-white p-6 rounded-md border border-gray-200 hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="font-semibold text-lg">Code Blitz</h3>
                      <p className="text-base text-gray-500">
                        by CodeWiz • 3 participants
                      </p>
                    </div>
                    <button
                      onClick={handleJoin} // Add onClick handler
                ...
                {/* Repeat for other public room items */}
                <div className="bg-white p-6 rounded-md border border-gray-200 hover:-translate-y-0.5 hover:shadow-md transition-all">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="font-semibold text-lg">Code Blitz</h3>
