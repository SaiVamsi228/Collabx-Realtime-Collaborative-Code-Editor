  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-white/100 backdrop-blur-md shadow-sm"
          : "bg-transparent"
      )}
    >
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {user ? (
            <>
              <Link
                to="/dashboard"
                className="px-5 py-2 text-white bg-black rounded-md"
              >
                Dashboard
              </Link>
              <button
                onClick={handleLogout}
                className="px-4 py-2 bg-white font-medium border border-black-2 text-black rounded-md"
              >
                Logout
              </button>
            </>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-backgroundA shadow-lg">
